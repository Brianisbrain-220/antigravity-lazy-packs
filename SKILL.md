...
| 07 | `07-clasp-netlify` | 連接 Clasp & Netlify MCP 部署 |
| 08 | `08-html-slide-builder` | 智慧 HTML 簡報生成器 |
| 09 | `09-video-specs` | 三類影片製作規範與自動渲染/打包技能 |
| 00 | `00-install-all` | 一次安裝全部 |

## 步驟二：讓使用者選擇

列出上表給使用者看，然後問：「你要安裝哪些？輸入全部或編號組合（例如 01, 02, 09）。」
