...
export const DEFAULT_EQUIPMENT_ITEMS = [
    ...
    { id: 'office_desk_4', category: 'office_desks', name: '辦公桌樣式 4', imageUrl: '/images/equipment/page_1_17_Image37.jpg', inputType: 'checkbox_with_quantity', sortOrder: 24 },
    { id: 'office_desk_5', category: 'office_desks', name: '辦公桌樣式 5', imageUrl: '/images/equipment/page_1_18_Image38.jpg', inputType: 'checkbox_with_quantity', sortOrder: 25 },
    { id: 'office_chair_1', category: 'office_chairs', name: '辦公椅樣式 1', imageUrl: '/images/equipment/page_1_19_Image39.jpg', inputType: 'checkbox_with_quantity', sortOrder: 31 },
    { id: 'office_chair_2', category: 'office_chairs', name: '辦公椅樣式 2', imageUrl: '/images/equipment/page_1_20_Image40.jpg', inputType: 'checkbox_with_quantity', sortOrder: 32 },
    { id: 'office_chair_3', category: 'office_chairs', name: '木椅', imageUrl: '/images/equipment/page_1_21_Image41.jpg', inputType: 'checkbox_with_quantity', sortOrder: 33 },
    { id: 'office_chair_4', category: 'office_chairs', name: '藤椅', imageUrl: '/images/equipment/page_1_22_Image42.jpg', inputType: 'checkbox_with_quantity', sortOrder: 34 },
    { id: 'curtain_1', category: 'multimedia', name: '窗簾_有', imageUrl: '/images/equipment/page_2_1_Image45.jpg', inputType: 'checkbox_only', sortOrder: 41 },
    { id: 'lectern_1', category: 'multimedia', name: '講桌_樣式1', imageUrl: '/images/equipment/page_2_2_Image46.jpg', inputType: 'checkbox_only', sortOrder: 42 },
    { id: 'lectern_2', category: 'multimedia', name: '講桌_樣式2', imageUrl: '/images/equipment/page_2_3_Image47.jpg', inputType: 'checkbox_only', sortOrder: 43 },
    { id: 'amp_1', category: 'amplifiers', name: '擴音機 1', imageUrl: '/images/equipment/page_2_4_Image48.jpg', inputType: 'checkbox_only', sortOrder: 51 },
    { id: 'amp_2', category: 'amplifiers', name: '擴音機 2', imageUrl: '/images/equipment/page_2_5_Image49.jpg', inputType: 'checkbox_only', sortOrder: 52 },
    { id: 'amp_3', category: 'amplifiers', name: '擴音機 3', imageUrl: '/images/equipment/page_2_6_Image50.jpg', inputType: 'checkbox_only', sortOrder: 53 },
    { id: 'amp_4', category: 'amplifiers', name: '擴音機 4', imageUrl: '/images/equipment/page_2_7_Image51.jpg', inputType: 'checkbox_only', sortOrder: 54 },
    { id: 'speaker_1', category: 'speakers', name: '喇叭 1', imageUrl: '/images/equipment/page_2_8_Image52.jpg', inputType: 'checkbox_only', sortOrder: 61 },
    { id: 'speaker_2', category: 'speakers', name: '喇叭 2', imageUrl: '/images/equipment/page_2_9_Image53.jpg', inputType: 'checkbox_only', sortOrder: 62 },
    { id: 'speaker_3', category: 'speakers', name: '喇叭 3', imageUrl: '/images/equipment/page_2_10_Image54.jpg', inputType: 'checkbox_only', sortOrder: 63 },
